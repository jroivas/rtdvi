//! hello-rs — minimal rtdvi plugin in Rust.
//!
//! ## Build
//!
//!   rustup target add wasm32-unknown-unknown
//!   cargo build --target wasm32-unknown-unknown --release
//!   cp target/wasm32-unknown-unknown/release/hello.wasm ~/.local/rtdvi/plugins/
//!
...
//!   <leader>h                     — same as :plugin hello.greet() (bound in rtdvi_init)
...
// ── rtdvi host imports ─────────────────────────────────────────────────────────
//
// The `wasm_import_module` attribute sets the WASM module name to "rtdvi".
...
/// Called for every command registered via rtdvi_register_command.
